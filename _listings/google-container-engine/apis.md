...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/deployment/master/_listings/google-container-engine/apis.yaml
...
- name: Google Container Engine API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/deployment/master/_listings/google-container-engine/v1-projects-projectid-zones-zone-serverconfig-get.md
x-common:
- type: x-change-log
