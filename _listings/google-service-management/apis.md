...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/deployment/master/_listings/google-service-management/apis.yaml
...
- name: Google Service Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/deployment/master/_listings/google-service-management/v1-resource-testiampermissions-post.md
x-common:
- type: x-change-log
